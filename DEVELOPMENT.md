...
```bash
git remote add encore encore://thesis-management-system-4zk2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/thesis-management-system-4zk2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/thesis-management-system-4zk2/settings/integrations/github)
